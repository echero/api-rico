...
describe('API RICO SEARCH', () => {
  describe('GET /search error interno', () => {
    // done[✔]
    it('Tiene éxito cuando la respuesta tiene un estado de error', async function () {
      chai
        .request(index)
        .get('/search')
        .query({ q: '_' })
    ...
    describe('GET /search?q=name', () => {
      // done [✔]
      it('Trae todos los restaurant que consiga que contiene la palabra que recibo por query string', function () {
        chai
          .request(index)
          .get('/search')
    ...
    describe('GET /search?q=name trae la informacion de un restaurante', () => {
      it('Trae todos los datos del restaurante buscado', function () {
        chai
          .request(index)
          .get('/search')
          .query({ q: 'La Pescadorita' })
    ...
    describe('GET /search?q=name no existe el nombre buscado', () => {
      // done
      it('No consiguio ningun restaurante por la palabra enviada por query params', function () {
        chai
          .request(index)
          .get('/search')
          .query({ q: 'Pizzarica' })
