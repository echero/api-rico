...
describe('API RICO', () => {
  describe('GET /user', () => {
    it('Trae todos los users del controlador', async function () {
  ...
  describe('POST /user', () => {
    ...
    describe('cuando el usuario no está en el nivel de otro', () => {
      ...
      it('muestra un usuario recién creado', function () {
        chai
          .request(index)
          .post('/user')
          .send({
  ...
  describe('DELETE /user', () => {
    it('Borra un restaurant por id de la lista de restaurantes', function () {
      chai
        .request(index)
        .delete('/user/1')
        .end((_, res) => {
