...
describe('API RICO', () => {
  describe('GET /restaurant', () => {
    it('Trae todos los restaurant del data/Restaurant', async function () {
  ...
  describe('GET /restaurant/:id', () => {
    it('Trae un user especifico', async function () {
  ...
  describe('POST /restaurant', () => {
    describe('cuando el rastaurant nuevo está en el nivel de otro', () => {
      it('no es posible aceptar ese restaurant', function () {});
    });

    describe('cuando el restaurant no está en el nivel de otro', () => {
      it('crea un restaurant', function () {
        chai
          .request(index)
          .post('/restaurant')
          .send({
            id: 4,
            name: 'Nuevo Restaurant La Vaca',
            direction: 'Av. Carabobo 1000',
            horario: '9am-23pm',
            tipoRestaurante: 'Parrilla',
            telefono: 47890987,
          })
      ...
      it('muestra un restaurant recién creado', function () {
        chai
          .request(index)
          .post('/restaurant')
          .send({
            ...
            direction: 'Av. Carabobo 2000',
            horario: '9am-23pm',
            tipoRestaurante: 'Teco',
            telefono: 47988090,
          })
          .end((_, res) => {
            expect(res).to.have.status(201); // CREATED
  ...
  describe('DELETE / restaurant', () => {
    it('Borra un restaurant por id de la lista de restaurants', function () {
      chai
        .request(index)
        .delete('/restaurant/1')
        .end((_, res) => {
  ...
  describe('PUT /restaurant', () => {
    it('Modifica un restaurant por id de la lista de restaurant', function () {
      chai
        .request(index)
        .put('/restaurant/5')
        .send({
